...
<div class="wrapper-text-description">
    ...
    <div class="wrapper-file">
        <div class="icon-file"><img src="{{asset('storage/posts/' .$categorie->name)}}" alt="" width="21" height="21"/></div>
          <div class="text-file">{{ $categorie->posts->name }} [{{ count($categorie->posts) }}]</div>
    </div>
